...
# pre-processing variables of year 2014
...
data2014 <- read.xport("~/Documents/DDC_study/LLCP2014.XPT")
...
data2014 = subset(data2014, data2014$X.AGEG5YR>2)
...
data2014$EMPLOY1[data2014$EMPLOY1 ==3] <- 13 
data2014$EMPLOY1[data2014$EMPLOY1 ==5] <- 15
data2014$EMPLOY1[data2014$EMPLOY1 ==4] <- 14
data2014$EMPLOY1[data2014$EMPLOY1 ==6] <- 16
data2014$EMPLOY1[data2014$EMPLOY1 ==13] <- 6 
data2014$EMPLOY1[data2014$EMPLOY1 ==15] <- 3
data2014$EMPLOY1[data2014$EMPLOY1 ==14] <- 5
data2014$EMPLOY1[data2014$EMPLOY1 ==16] <- 4
