...
# pre-processing variables of year 2013
...
data2013 <- read.xport("~/Downloads/GDM_data/LLCP2013.XPT")
...
data2013 = subset(data2013, data2013$X.AGEG5YR>2)
...
data2013$EMPLOY1[data2013$EMPLOY1 ==3] <- 13 
data2013$EMPLOY1[data2013$EMPLOY1 ==5] <- 15
data2013$EMPLOY1[data2013$EMPLOY1 ==4] <- 14
data2013$EMPLOY1[data2013$EMPLOY1 ==6] <- 16
data2013$EMPLOY1[data2013$EMPLOY1 ==13] <- 6 
data2013$EMPLOY1[data2013$EMPLOY1 ==15] <- 3
data2013$EMPLOY1[data2013$EMPLOY1 ==14] <- 5
data2013$EMPLOY1[data2013$EMPLOY1 ==16] <- 4
