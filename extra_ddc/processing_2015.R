...
mdh #upper interval
#CI 95% subset
data2015 = subset(data2015, data2015$DIABAGE2 >= 30) #diabetes diagnose age of 30 or above
...
data2015 = data2015[!is.na(data2015$X.AGEG5YR),] #removing missing values
data2015 = subset(data2015, data2015$X.AGEG5YR<14) #include 1 to 13 age groups


#processing for gender
table(data2015$SEX)
data2015 = data2015[!is.na(data2015$SEX),] #removing missing values
table(data2015$SEX)
nrow(data2015)

#processing for ethnicity 
table(data2015$X.RACE.G1)
data2015 = data2015[!is.na(data2015$X.RACE.G1),] #removing missing values
data2015 = subset(data2015, data2015$X.RACE.G1<6) #include 1 to 5 sub groups
table(data2015$X.RACE.G1)
nrow(data2015)
...
data2015 = data2015[!is.na(data2015$EXERANY2),] #removing missing values
data2015 = subset(data2015, data2015$EXERANY2<7) #exercise (1) yes or (2) no
table(data2015$EXERANY2)
nrow(data2015)

#processing for mental health
table(data2015$MENTHLTH)
data2015 = data2015[!is.na(data2015$MENTHLTH),] #removing missing values
data2015$MENTHLTH[data2015$MENTHLTH == 88] <- 0
data2015 = subset(data2015, data2015$MENTHLTH<77) #mental health not good 0 to 30 days
table(data2015$MENTHLTH)
nrow(data2015)

#processing for income
table(data2015$INCOME2)
data2015 = data2015[!is.na(data2015$INCOME2),] #removing missing values
data2015 = subset(data2015, data2015$INCOME2<9) #income levels 1 to 8
table(data2015$INCOME2)
nrow(data2015)

#processing for employment
table(data2015$EMPLOY1)
data2015 = data2015[!is.na(data2015$EMPLOY1),] #removing missing values
#arranging the level of employment status
...
data2015 = subset(data2015, data2015$EMPLOY1<9) #including 1 to 8 levels of employment status
table(data2015$EMPLOY1)
nrow(data2015)

#processing for education 
table(data2015$EDUCA)
data2015 = data2015[!is.na(data2015$EDUCA),] #removing missing values
data2015 = subset(data2015, data2015$EDUCA<9) #including 1 to 8 education level
table(data2015$EDUCA)
nrow(data2015)

#processing  for worried about rent
table(data2015$SCNTMNY1)
data2015 = data2015[!is.na(data2015$SCNTMNY1),] #removing missing values
...
data2015 = data2015[!is.na(data2015$SCNTMEL1),] #removing missing values
...
data2015 = data2015[!is.na(data2015$RENTHOM1),] #removing missing values
...
data2015 = data2015[!is.na(data2015$DIABETE3),] #removing missing values
...
data2015 = data2015[!is.na(data2015$ADDEPEV2),] #removing missing values
